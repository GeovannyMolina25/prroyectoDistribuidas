...
const {getCombustibleControler, insertarDatosControlCombustible,getCondVehiculo,getVehiConductor,
    ...
    getConductorContrlCombustiblePorFecha,getDatosDashboartPorFecha,getDatosGraficoPorfecha,getDatosGraficoPorfechaPorId,getObtenerPlaca} = require('../controllers/controlCombustible.controller')
...
router.get("/ubicacionSinRepetirOrigen", getUbicacionSinRepetirOrigen);
...
router.get(
  "/ControlRegistro/descVehiculo/:descripcion",
...
router.get(
  "/ControlRegistro/DatosControlCombustible",
...
router.get(
  "/ControlRegistro/DatosControlCombustiblePorConductor/:id",
  getDatosControlCombustiblePorConductor
);
// obtener destinofinal dependiendo del destino inicial
router.get(
  "/ControlRegistro/UbiFinalPorUbiOrigen/:origen",
...
router.get('/ControlRegistro/DatosDashboartPorFecha/:fecha',getDatosDashboartPorFecha);
...
router.get('/ControlRegistro/getObtenerPlaca',getObtenerPlaca);
